            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6">
                ...
                <div className="flex flex-col gap-6 mb-8">
                    <div className="flex items-center gap-2 md:gap-4 w-full">
                        <button className="hidden md:flex p-2.5 rounded-full bg-slate-50 border border-slate-100 text-slate-400 hover:text-slate-600 transition-colors shrink-0">
                            <ChevronLeft className="w-5 h-5" />
                        </button>
                        <button className="md:hidden p-2 rounded-xl bg-slate-50 border border-slate-100 text-slate-400 shrink-0">
