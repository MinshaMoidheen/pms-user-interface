  ...
  return (
    <div className="flex flex-row gap-2 md:gap-4 w-full items-center p-1.5 bg-white rounded-[32px] shadow-sm border border-slate-100">
      ...
      <button
        ...
        className="bg-blue-700 hover:bg-blue-800 text-white font-semibold rounded-full transition-colors whitespace-nowrap shadow-sm shadow-blue-200 flex items-center justify-center h-11 md:h-14 w-11 md:w-auto md:px-8"
      >
