  ...
  return (
    <div className="flex flex-col md:flex-row gap-4 w-full items-center">
      ...
      <button
        ...
        className="w-full md:w-auto bg-blue-700 hover:bg-blue-800 text-white font-semibold px-8 py-3.5 rounded-full transition-colors whitespace-nowrap shadow-sm shadow-blue-200"
      >
        Find Job
      </button>
    </div>
