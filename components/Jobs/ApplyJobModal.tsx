...
const ApplyJobModal: React.FC<ApplyJobModalProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      body.append("mobileNumber", formData.phone);
      body.append("resume", formData.cv);

      await applyJob({ id: job._id, body }).unwrap();
  ...
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    if (e.target.files && e.target.files[0]) {
      ...
      if (file.size > 12 * 1024 * 1024) {
        setError("File size exceeds 12MB");
        return;
      }
          ...
          {isSuccess ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2.5 rounded-lg text-black  border border-slate-200 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-all placeholder:text-slate-400"
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full pl-10 pr-4 py-2.5 rounded-lg text-black border border-slate-200 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-all placeholder:text-slate-400"
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="flex">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2.5 rounded-r-lg text-black border border-slate-200 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-all placeholder:text-slate-400"
              ...
              <div className="space-y-3">
                ...
                <div
                  className={`border-2 border-dashed rounded-xl p-8 transition-colors group cursor-pointer relative ${formData.cv ? "border-green-200 bg-green-50" : "border-slate-200 hover:border-blue-400"}`}
                >
                  <input
                    type="file"
                  ...
                  <div className="flex flex-col items-center justify-center text-center">
                    <div
                      className={`w-12 h-12 rounded-full flex items-center justify-center mb-3 transition-colors ${formData.cv ? "bg-green-100 text-green-600" : "bg-slate-50 text-slate-400 group-hover:bg-blue-50 group-hover:text-blue-500"}`}
                    >
                      {formData.cv ? (
