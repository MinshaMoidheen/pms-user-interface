      ...
      <main className="max-w-7xl mx-auto px-4 md:px-8 py-6 mt-20">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-xl md:text-2xl font-bold bg-white">
          ...
          <div className="flex-1 space-y-12">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between p-4 md:p-6 bg-white border border-gray-100 rounded-2xl md:rounded-[32px] shadow-sm gap-4">
              <div className="flex items-center gap-3 md:gap-4 w-full sm:w-auto">
                ...
                <div className="space-y-0.5 md:space-y-1">
                  <h4 className="font-bold text-sm md:text-base text-[#1E293B]">
                    Property Listed by {displayedProperty.contact.name}
                  </h4>
                  <div className="flex items-center gap-1 text-[#3B82F6] font-semibold text-[10px] md:text-xs">
                    <CheckCircle
                      size={12}
                      className="fill-[#3B82F6] text-white"
                    />
            ...
            <div className="space-y-6">
              <h3 className="text-xl md:text-2xl font-bold text-[#1E293B]">
                Price Negotiable | Handed Over | Multiple Options
              </h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-12 gap-y-4">
                {[
                  ...
                  <div
                    key={idx}
                    className="flex justify-between sm:justify-start gap-4 sm:gap-8 group border-b sm:border-b-0 pb-2 sm:pb-0 border-gray-50 last:border-0"
                  >
            ...
            <div className="space-y-6 md:space-y-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-4 md:gap-y-6">
                {[
                  ...
                  {
                    icon: <Laptop size={20} className="text-gray-600" />,
                  ...
                  {
                    icon: <ParkingCircle size={20} className="text-gray-600" />,
                    label: "Dedicated Parking slots",
                  },
                  {
                  ...
                  {
                    icon: <Droplets size={20} className="text-gray-600" />,
                    label: "Drinking water supply",
                  },
                  {
                    icon: <Trophy size={20} className="text-gray-600" />,
                    label: "Sports activity spaces",
                  },
                ].map((item, i) => (
              ...
              <div className="flex flex-col md:flex-row gap-12 items-start">
                ...
                <div className="w-full md:w-[340px] bg-[#FFF5F2] p-8 rounded-[40px] flex flex-col items-center">
                  ...
                  <h4 className="text-xl font-bold text-[#1E293B] mb-1">
                    {displayedProperty.contact.name}
                  </h4>
                  ...
                  <div className="w-full text-center">
                    <p className="text-sm font-bold text-[#1E293B] mb-4">
                      Message {displayedProperty.contact.name}
                    </p>
                ...
                <div className="flex-1 space-y-6 md:space-y-10 pt-2 w-full">
                  ...
                  <div>
                    <h4 className="text-xl md:text-2xl font-bold text-[#1E293B] mb-4 md:mb-6 text-center md:text-left">
                      Properties
                    </h4>
                    <div className="space-y-3 md:space-y-4 max-w-lg mx-auto md:mx-0">
                      <div className="flex justify-between md:grid md:grid-cols-[140px_20px_1fr] items-center border-b md:border-b-0 pb-2 md:pb-0 border-gray-50">
                        <span className="text-[#64748B] font-medium text-sm md:text-base">
                          For Sale
                        </span>
                        <span className="hidden md:inline text-[#64748B] font-medium">
                          :
                        </span>
                        <span className="text-[#1E293B] font-bold text-sm md:text-base">
                          12
          ...
          <div className="lg:w-[380px] w-full sticky top-28">
            <div className="bg-[#F8FAFC] p-8 rounded-[32px] border border-gray-100/50 shadow-sm">
              ...
              <div className="space-y-4">
                <button
                  onClick={() =>
                    (window.location.href = `mailto:${displayedProperty.contact.email}`)
                  }
