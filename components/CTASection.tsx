      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="relative bg-[#FFEDEB] rounded-[40px] overflow-hidden flex flex-col md:flex-row items-center">
          <div className="p-8 md:p-16 flex-1">
            ...
            <button className="bg-white text-slate-900 px-10 py-4 rounded-full font-bold shadow-xl shadow-orange-100 hover:shadow-orange-200 transition-all transform hover:-translate-y-1">
              Place an Ad
            </button>
          </div>
