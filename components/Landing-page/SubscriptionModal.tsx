...
} from "@/store/services/subsciptionApiSlice";
...
const SubscriptionModal: React.FC<SubscriptionModalProps> = ({
    ...
    if (isPlansLoading) {
      return (
        <div className="flex flex-col items-center justify-center p-20 gap-4">
          <Loader2 className="animate-spin text-[#1A3EB5]" size={40} />
          <p className="font-bold text-gray-400">Loading our plans...</p>
        </div>
      );
    }
    ...
    switch (step) {
          ...
          <div className="flex flex-col md:flex-row gap-8 items-stretch h-full">
            <div className="flex-1">
              ...
              <p className="text-gray-500 text-sm mb-6">
                Unlock guaranteed interview chances and dedicated support
              </p>

              <div className="space-y-4 mb-8 overflow-y-auto max-h-[400px] pr-2 scrollbar-hide">
                {plans.map((plan: any) => (
                  <div
                    key={plan._id}
                  ...
                  >
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <div className="flex items-baseline gap-1">
                        <span className="text-2xl font-black text-[#1A3EB5]">
                          {plan.currency}
                          {plan.price}
                        </span>
              ...
              <button
                ...
                className="w-full bg-[#1A3EB5] text-white py-4 rounded-full font-bold text-lg hover:bg-blue-700 transition-colors mb-2 disabled:bg-gray-200 disabled:cursor-not-allowed"
              >
                Continue
              </button>
            ...
            <div className="hidden lg:flex flex-1 items-center justify-center relative bg-gray-50 rounded-2xl overflow-hidden p-8">
              <Image
        ...
        return (
          <form onSubmit={handleContinue} className="h-full flex flex-col">
            ...
            <div className="space-y-6 flex-1">
              <div>
                <label className="block text-sm font-medium text-gray-400 mb-2 uppercase tracking-tight">
                  Contact info
                </label>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        type="text"
                        placeholder="Name"
                        className="w-full px-4 py-3 rounded-xl border text-black border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all text-sm"
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full pl-10 pr-4 py-3 rounded-xl text-black border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all text-sm"
                  ...
                  <div>
                    ...
                    <div className="flex gap-2">
                      ...
                      <input
                        ...
                        className="flex-1 px-4 py-3 rounded-xl text-black border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all text-sm"
      ...
      case 3: {
        const handleActivate = async () => {
          ...
          try {
            // Using placeholder for paymentId as per activateSubscriptionRequest
            await activateSubscription({
              subscriptionId: selectedPlanId,
              paymentId: "WHATSAPP_PAY_PENDING",
            }).unwrap();
            nextStep();
          } catch (error) {
          ...
          <div className="flex flex-col md:flex-row gap-8 items-center h-full">
            ...
            <div className="flex-1">
              ...
              <button
                ...
                className="w-full bg-[#1A3EB5] text-white py-4 rounded-xl font-bold text-lg hover:bg-blue-700 transition-colors flex items-center justify-center gap-2 disabled:bg-blue-300"
              >
                {isActivating ? (
                  <>
            ...
            <div className="w-full bg-[#1A3EB5] rounded-3xl p-12 mb-8 relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <h2 className="text-2xl md:text-3xl font-extrabold text-white mb-2">
                  You are now our <br /> {selectedPlan?.name || "Subscribed"}{" "}
                  Member.
                </h2>
                <p className="text-blue-100 text-sm mb-4">
                  You have unlocked the benefits of this plan.
                </p>
                <div className="inline-block bg-white/10 px-4 py-1 rounded-full text-white text-xs border border-white/20">
                  Subscription active for {selectedPlan?.duration || 30} days
                </div>
              </div>
            </div>
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal Container */}
      <div
        className={`relative w-full ${step === 4 ? "max-w-lg" : "max-w-4xl"} bg-white rounded-[32px] p-6 md:p-10 shadow-2xl transform transition-all overflow-hidden max-h-[95vh]`}
      >
        {/* Close Button */}
        <button
          onClick={onClose}
